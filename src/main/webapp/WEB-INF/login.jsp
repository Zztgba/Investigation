...
<div class="right">
    ...
    <div id="main">
        <form action="${pageContext.request.contextPath }/user/login" method="post">
            ...
            <c:choose>
                <c:when test="${mes eq null}"></c:when>
                <c:otherwise><br /><label style="color:red;text-align: center;width: 90px;height:20px;margin:10px auto;display:block;">${mes}</label></c:otherwise>
            </c:choose>
    ...
    <div id="main1">
        <form name="formInsert" action="${pageContext.request.contextPath }/user/insert" method="post">
            <input type="text" id="uname" placeholder="用户名" class="name" name="name">
...
<script type="text/javascript">
    ...
    var oPass=document.getElementsByName('password')[1];
